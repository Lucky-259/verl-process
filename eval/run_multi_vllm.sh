...
JOBS=(
  ...
  "Redundancy_DAPO qwen3_1.7B_8k_redundancy_self_correct_1_5e-4_DAPO 16 150 100,200,250,300"
  "Redundancy_DAPO qwen3_1.7B_8k_DAPO_base 16 150 100,200,250,300"
  "Redundancy_DAPO DS7B_8k_DAPO_base 16 150 100,200,250,300"
  "Redundancy_DAPO qwen3_8B_8k_redundancy_self_correct_1_5e-4_DAPO 16 150 100,200,250,300"
