...
CHECKPOINT_ROOT="/mnt/hdfs/if_au/saves/xsj/ckpts/${PROJECT_NAME}/${EXPERIMENT_NAME}"
OUTPUT_ROOT="/mnt/hdfs/if_au/saves/cky/eval_results/${EXPERIMENT_NAME}"

DATASETS=("minerva" "olympiad_bench")
...
# ============ CSV Headers ============
SUMMARY_FILE="$OUTPUT_ROOT/all_checkpoints_summary_xsj.csv"
...
GLOBAL_SUMMARY_FILE="$GLOBAL_OUTPUT_ROOT/all_jobs_summary_8k_xsj.csv"
