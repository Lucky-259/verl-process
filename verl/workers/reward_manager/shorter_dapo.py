...
@register("dapo_shorter")
class DAPOShorterRewardManager:
    """The reward manager.
    """

    def __init__(self, tokenizer, num_examine, num_generation, compute_score=None, reward_fn_key="data_source", max_resp_len: Optional[int] = None, overlong_buffer_cfg=None, beta=0.001) -> None:
