...
MODEL_PREFIX="../eval_results/analysis/DS7B_8k_redundancy_self_1_5e-4_1_correct_DAPO/${MODEL_NAME}"
BASE_DIR="../../eval/redundancy/DS7B_8k_redundancy_self_1_5e-4_1_correct_DAPO/${MODEL_NAME}"
MIN_SCORE=2

if [ "$#" -ne 3 ]; then
  echo "❌ 用法: ./run_verify.sh <MODEL_NAME> <EXTRACTION> <WAY>"
