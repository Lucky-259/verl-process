...
EXPERIMENT_NAME='DS1.5B_8k_1e_4_4096_DAPO_l1'
...
python3 -u -m recipe.dapo.main_dapo \
    reward_model.reward_manager=l1_dapo \
    +reward_model.reward_kwargs.alpha=1e-4 \
    +reward_model.reward_kwargs.n_gold=4096 \
